...
<div class="page narrow">
  ...
  <div class="aside-navi-container">
    <div id="aside-navi-wrap" class="aside-navi-wrap asScrollable is-enabled asScrollable-vertical">
      <div class="asScrollable-container" style="height: 530px; width: 87px;">
    ...
    <div class="asScrollable-bar asScrollable-bar-vertical asScrollable-bar-hide" draggable="false"><div class="asScrollable-bar-handle" style="height: 393.714px;"></div></div></div>
  </div>
</div>
  <div class="page-main">
  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
      ...
      <div class="navbar-header">统计分析</div>
  ...
  <section class="page-aside-section">
    <h5 class="page-aside-title">客户统计</h5>
    <div class="list-group">
      <a class="list-group-item" href="/statistics/customer?type=0">
        <span class="list-group-item-content">创建客户统计</span>
      </a>
      <a class="list-group-item" href="/statistics/customer?type=5">
        <span class="list-group-item-content">创建客户统计(员工维度)</span>
      </a>
      <a class="list-group-item" href="/statistics/customer?type=1">
        <span class="list-group-item-content">联系客户统计</span>
      </a>
      <a class="list-group-item" href="/statistics/customer?type=6">
        <span class="list-group-item-content">联系客户统计(员工维度)</span>
      </a>
      <a class="list-group-item" href="/statistics/customer?type=2">
        <span class="list-group-item-content">成交客户统计</span>
      </a>
      <a class="list-group-item" href="/statistics/customer?type=7">
        <span class="list-group-item-content">成交客户统计(员工维度)</span>
      </a>
      <a class="list-group-item" href="/statistics/customer?type=3">
        <span class="list-group-item-content">客户分类统计</span>
      </a>
      <a class="list-group-item" href="/statistics/customer?type=4">
        <span class="list-group-item-content">客户标签统计</span>
      </a>
    </div>
    <h5 class="page-aside-title">销售机会统计</h5>
    <div class="list-group">
      <a class="list-group-item active" href="/statistics/deal?type=0">
        <span class="list-group-item-content">创建销售机会统计</span>
      </a>
      <a class="list-group-item" href="/statistics/deal?type=1">
        <span class="list-group-item-content">销售机会阶段统计</span>
      </a>
      <a class="list-group-item" href="/statistics/deal?type=2">
        <span class="list-group-item-content">销售机会状态统计</span>
      </a>
    </div>
    <h5 class="page-aside-title">合同统计</h5>
    <div class="list-group">
      <a class="list-group-item" href="/statistics/contract">
        <span class="list-group-item-content">合同统计</span>
      </a>
    </div>
    <h5 class="page-aside-title">款项统计</h5>
    <div class="list-group">
      <a class="list-group-item" href="/statistics/payment">
        <span class="list-group-item-content">款项统计</span>
      </a>
      <a class="list-group-item" href="/statistics/invoice">
        <span class="list-group-item-content">票据统计</span>
      </a>
    </div>
    <h5 class="page-aside-title">呼叫中心统计</h5>
    <div class="list-group">
      <a class="list-group-item" href="/statistics/callCenter?type=0">
        <span class="list-group-item-content">按员工统计</span>
      </a>
      <a class="list-group-item" href="/statistics/callCenter?type=1">
        <span class="list-group-item-content">按部门统计</span>
      </a>
      <a class="list-group-item" href="/statistics/callCenter?type=2">
        <span class="list-group-item-content">按地域统计</span>
      </a>
    </div>
    <h5 class="page-aside-title">微信统计</h5>
    <div class="list-group">
      <a class="list-group-item" href="/statistics/weixin">
        <span class="list-group-item-content">微信统计</span>
      </a>
    </div>
  </section>
</div>
      <div class="page-main-content">
        <div>
          <form class="form-inline" id="statistics-search-form">
            <div class="form-group">
              <label class="control-label padding-right-10" for="statistics-search-createDate">创建时间</label>
              <div class="input-group input-daterange" id="statistics-search-createDate">
                <input type="text" class="form-control" value="2018-09-04" name="statistics-search-startCreateDate" id="statistics-search-startCreateDate">
                <div class="input-group-addon">到</div>
                <input type="text" class="form-control" value="2018-09-11" name="statistics-search-endCreateDate" id="statistics-search-endCreateDate">
              </div>
            </div>

            <div class="form-group padding-left-10">
              <label class="control-label padding-right-10" for="statistics-search-groupId">部门</label>
              <select class="form-control select2-hidden-accessible" name="statistics-search-groupId" id="statistics-search-groupId" data-plugin="select2" data-language="zh-CN" style="width:300px" tabindex="-1" aria-hidden="true"><option value="">全部</option></select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 300px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-statistics-search-groupId-container"><span class="select2-selection__rendered" id="select2-statistics-search-groupId-container" title="全部">全部</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
            </div>

            <div class="form-group padding-left-10">
              <label class="control-label padding-right-10" for="statistics-search-userId">员工</label>
              <select class="form-control select2-hidden-accessible" name="statistics-search-userId" id="statistics-search-userId" data-plugin="select2" data-language="zh-CN" style="width:180px;" tabindex="-1" aria-hidden="true">
                <option value="">全部</option>
                <option value="QVtaSg==">孙伟</option>
              </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 180px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-statistics-search-userId-container"><span class="select2-selection__rendered" id="select2-statistics-search-userId-container" title="全部">全部</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
            </div>

            <div class="form-group padding-left-10">
              <button type="submit" class="btn btn-success btn-sm" id="statistics-search-btn">搜索</button>
            </div>
          </form>
        </div>

        <div id="statistics-chart-panel" class="padding-top-40" style="height: 400px; min-width: 310px; width: 100%; -webkit-tap-highlight-color: transparent; user-select: none; position: relative; background: transparent;" _echarts_instance_="ec_1536628645822"><div style="position: relative; overflow: hidden; width: 1462px; height: 360px; padding: 0px; margin: 0px; border-width: 0px; cursor: default;"><canvas width="1462" height="360" data-zr-dom-id="zr_0" style="position: absolute; left: 0px; top: 0px; width: 1462px; height: 360px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas></div><div></div></div>

        <div class="table-responsive page-content-table padding-top-40">
          <table class="table table-pointer table-striped" id="statistics-table">
            <thead>
            <tr>
              <th class="cell-80 header">编号</th>
              <th class="cell-200 header">日期</th>
              <th class="cell-200 header">数量</th>
              <th class="header">金额 (元)</th>
            </tr>
            </thead>
            <tbody id="statistics-body">
            <tr class="hide" id="statistics-item-clone">
              <td class="idx"></td>
              <td class="date"></td>
              <td class="count">0</td>
              <td class="sum">0</td>
            </tr>
            <tr class="statistics-item" id="chart-item-2018-09-04">
              <td class="idx">1</td>
              <td class="date">2018-09-04</td>
              <td class="count">0</td>
              <td class="sum">0</td>
            </tr><tr class="statistics-item" id="chart-item-2018-09-05">
              <td class="idx">2</td>
              <td class="date">2018-09-05</td>
              <td class="count">0</td>
              <td class="sum">0</td>
            </tr><tr class="statistics-item" id="chart-item-2018-09-06">
              <td class="idx">3</td>
              <td class="date">2018-09-06</td>
              <td class="count">0</td>
              <td class="sum">0</td>
            </tr><tr class="statistics-item" id="chart-item-2018-09-07">
              <td class="idx">4</td>
              <td class="date">2018-09-07</td>
              <td class="count">0</td>
              <td class="sum">0</td>
            </tr><tr class="statistics-item" id="chart-item-2018-09-08">
              <td class="idx">5</td>
              <td class="date">2018-09-08</td>
              <td class="count">0</td>
              <td class="sum">0</td>
            </tr><tr class="statistics-item" id="chart-item-2018-09-09">
              <td class="idx">6</td>
              <td class="date">2018-09-09</td>
              <td class="count">0</td>
              <td class="sum">0</td>
            </tr><tr class="statistics-item" id="chart-item-2018-09-10">
              <td class="idx">7</td>
              <td class="date">2018-09-10</td>
              <td class="count">1</td>
              <td class="sum">80</td>
            </tr><tr class="statistics-item" id="chart-item-2018-09-11">
              <td class="idx">8</td>
            ...
            <tr>
              <td>合计</td>
              <td></td>
              <td id="statistics-totalNum">1</td>
              <td id="statistics-totalMoney">80</td>
            </tr>
            </tfoot>
          </table>
        </div>
...
<script type="text/javascript" src="script/vendor/jquery-ui.min.js"></script>
...
<script type="text/javascript" src="script/vendor/jquery.tablesorter.min.js"></script>
<script type="text/javascript" src="script/statistics-entity.js"></script>
