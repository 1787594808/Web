...
<div class="page narrow">
  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
      ...
      <div class="navbar-header">工作汇报</div>
    ...
    <div class="page-main-container">
      <div>
        <div class="nav-tabs-horizontal">
          <ul class="nav nav-tabs nav-tabs-line" id="workReport-list-tab">
            <li>
              <a href="/workReport?type=2">汇报给我的工作汇报</a></li>
            <li>
              <a href="/workReport?type=0">我的工作汇报</a></li>
            <li>
              <a href="/workReport?type=1">我下属的工作汇报</a></li>
            <li class="active"><a href="/workReport/statistics">工作汇报统计</a></li>
          </ul>

          <div class="text-center padding-top-40">
            <span class="border-box">
              <a data-tooltip="tooltip" data-original-title="查看上周统计数据" href="/workReport/statistics?startDate=2018-09-03">
                <i class="iconfont icon-left"></i>
              </a>
              <span class="padding-horizontal-10">2018-09-10</span>
              ~
              <span class="padding-horizontal-10">2018-09-16</span>
              
            </span>
          </div>

          <div class="loading padding-top-40" id="search-loading" style="display: none;">
  <div class="liner">
    <h3>加载中...</h3>
    <img alt="加载中" src="/images/dots-white.gif">
          ...
          <div class="table-responsive page-content-table padding-top-40" id="entity-item-list">
            <table class="table table-pointer table-hover">
              <thead>
              <tr>
                <th class="cell-120">员工</th>
                <th>
                  <span>09-10</span> (<span id="week-title-0">星期一</span>)
                </th>
                <th>
                  <span>09-11</span> (<span id="week-title-1">星期二</span>)
                </th>
                <th>
                  <span>09-12</span> (<span id="week-title-2">星期三</span>)
                </th>
                <th>
                  <span>09-13</span> (<span id="week-title-3">星期四</span>)
                </th>
                <th>
                  <span>09-14</span> (<span id="week-title-4">星期五</span>)
                </th>
                <th>
                  <span>09-15</span> (<span id="week-title-5">星期六</span>)
                </th>
                <th>
                  <span>09-16</span> (<span id="week-title-6">星期日</span>)
                </th>
                <th></th>
              </tr>
              </thead>
              <tbody id="workReport-table-body">
                <tr>
                  <td class="item-user" data-value="QVtaSg==">孙伟</td>
                  <td id="item-QVtaSg==-09-10"> 未汇报 </td>
                  <td id="item-QVtaSg==-09-11"> 未汇报 </td>
                  <td id="item-QVtaSg==-09-12"> 未汇报 </td>
                  <td id="item-QVtaSg==-09-13"> 未汇报 </td>
                  <td id="item-QVtaSg==-09-14"> 未汇报 </td>
                  <td id="item-QVtaSg==-09-15"> 未汇报 </td>
                  <td id="item-QVtaSg==-09-16"> 未汇报 </td>
...
<script type="text/javascript">
  /*<![CDATA[*/
  var _startDate = "2018-09-10";
  var _weeks = ["星期一","星期二","星期三","星期四","星期五","星期六","星期日"];
...
<script type="text/javascript" src="script/workReport-statistics.js"></script>
