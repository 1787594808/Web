$(function () {
    ...
    $("[data-plugin='datepicker']").datepicker({format: "yyyy-mm-dd", autoclose: true, todayBtn: "linked"});
    $("[data-plugin='datetimepicker']").datetimepicker({format: "YYYY-MM-DD HH:mm:ss"});
    ...
    $("#recordModal").on("show.bs.modal", function (c) {
        ...
        $("#recordModal-audio").html("<audio src='/file/download?key=" + encodeURIComponent(a) + "&fileName=callrecord.mp3' preload='auto' controls></audio>");
