...
<div class="page narrow">
  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
      ...
      <div class="navbar-header">跟进记录一览</div>
  ...
  <div class="modal fade" id="downloadAppModal" aria-hidden="true" role="dialog" data-backdrop="static" data-keyboard="false" tabindex="-1">
    ...
    <div class="page-main-container">
      <div>
  <form class="form-inline" id="search-note-form">
    <div class="form-group">
    ...
    <div class="form-group padding-left-10">
      <label class="control-label padding-right-10" for="search-contactDate">跟进时间</label>
      <div class="input-group input-daterange" id="search-contactDate">
        <input type="text" class="form-control" value="" name="search-startContactDate" id="search-startContactDate">
        <div class="input-group-addon">到</div>
        <input type="text" class="form-control" value="" name="search-endContactDate" id="search-endContactDate">
      </div>
    </div>

    <div class="form-group padding-left-10">
      <label class="control-label padding-right-10" for="search-createUserId">跟进人</label>
      <select class="form-control select2-hidden-accessible" name="search-createUserId" id="search-createUserId" data-plugin="select2" data-language="zh-CN" style="width:180px;" tabindex="-1" aria-hidden="true">
        <option value="">全部</option>
        <option value="QVtaSg==">孙伟</option>
      </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 180px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-search-createUserId-container"><span class="select2-selection__rendered" id="select2-search-createUserId-container" title="全部">全部</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
    </div>

    <div class="form-group padding-left-10">
      <label class="control-label padding-right-10" for="search-term">跟进内容</label>
  ...
  <div class="table-responsive page-content-table padding-top-20" id="entity-item-list">
    <table class="table table-pointer table-hover">
      ...
      <tr>
        ...
        <th class="cell-250">客户名称</th>
        <th class="cell-100">联系人</th>
        <th class="cell-150">备注对象</th>
        <th class="cell-200">跟进时间</th>
        <th class="cell-100">跟进员工</th>
        <th>跟进内容</th>
        <th></th>
      </tr>
      </thead>
      ...
      <tr id="item-clone" class="hide">
        <td class="idx"></td>
        <td><a target="_blank" href="#" class="note-customerName"></a></td>
        <td><a target="_blank" href="#" class="note-contactName"></a></td>
        <td><a target="_blank" href="#" class="note-targetName"></a></td>
        <td class="note-contactDate"></td>
        <td class="note-createUser"></td>
        <td class="note-remark"></td>
        <td class="suf-cell"></td>
      </tr>
      <tr id="note-item-RlxRRxhYQg==" class="list-item">
        <td class="idx">1</td>
        <td><a target="_blank" href="/customer/detail/RV1RQhheQw%3D%3D" class="note-customerName" id="note-item-RV1RQhheQw==-2">北京博众致远网络科技有限公司</a></td>
        <td><a target="_blank" href="/contact/detail/" class="note-contactName" id="note-item--3"></a></td>
        <td><a target="_blank" href="/customer/detail/RV1RQhheQw%3D%3D" class="note-targetName" id="note-item-RV1RQhheQw==-2">北京博众致远网络科技有限公司</a></td>
        <td class="note-contactDate">2018-09-10 14:12:27</td>
        <td class="note-createUser">孙伟</td>
        <td class="note-remark">今天上午拜访了客户，详细讲解了企客宝客户管理系统的功能，客户表示很有兴趣，计划下周一再去拜访客户</td>
        <td class="suf-cell"></td>
      </tr></tbody>
    </table>
  </div>
  ...
  <div id="note-blank" class="loading" style="display: none;">
  <div class="liner">
    <h3>没有找到相关跟进记录</h3>
  </div>
</div>
...
<script type="text/javascript" src="script/note-list.js"></script>
