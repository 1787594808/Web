...
<div class="page narrow">
  ...
  <div class="aside-navi-container">
    ...
    <div class="asScrollable-bar asScrollable-bar-vertical asScrollable-bar-hide" draggable="false"><div class="asScrollable-bar-handle" style="height:517.684px;"></div></div></div>
  </div>
</div>
  <div class="page-main">
      ...
      <div class="page-main-content">
        ...
        <div class="page-main-actions">
          ...
          <form class="form-inline" id="search-worksheet-form">
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="" name="search-name" id="search-name">
            </div>
        ...
        <div class="table-responsive page-content-table padding-top-20" id="entity-item-list">
          <table class="table table-pointer table-striped nowrap">
            ...
            <tr id="worksheet-item-clone" class="hide">
              <td class="idx"></td>
              <td class="item-name">
                <a href="#"></a>
              </td>
...
<div class="modal fade" id="worksheetModal" aria-hidden="true" role="dialog" data-backdrop="static" data-keyboard="false" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body padding-horizontal-20">
        <form class="form-horizontal" id="form-add-worksheet">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input class="form-control" id="worksheet-title" name="worksheet-title" data-field-required="true" value="">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select class="form-control select2-hidden-accessible" name="worksheet-templateId" id="worksheet-templateId" data-plugin="select2" data-language="zh-CN" data-width="100%" data-field-required="true" tabindex="-1" aria-hidden="true">
                <option value="">请选择</option>
                <option value="QFVdSQ==">工单模板一</option>
              </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-worksheet-templateId-container"><span class="select2-selection__rendered" id="select2-worksheet-templateId-container" title="请选择">请选择</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select class="form-control select2-hidden-accessible" name="worksheet-customerId" id="worksheet-customerId" data-language="zh-CN" data-width="100%" tabindex="-1" aria-hidden="true">
              </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-worksheet-customerId-container"><span class="select2-selection__rendered" id="select2-worksheet-customerId-container"><span class="select2-selection__placeholder">请输入客户名检索</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
              <small class="help-block"></small>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select class="form-control select2-hidden-accessible" name="worksheet-priority" id="worksheet-priority" data-plugin="select2" data-language="zh-CN" data-width="100%" tabindex="-1" aria-hidden="true">
                <option value="0">-</option>
                <option value="1">低</option>
                <option value="2">中</option>
                <option value="3">高</option>
                <option value="4">紧急</option>
              </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-worksheet-priority-container"><span class="select2-selection__rendered" id="select2-worksheet-priority-container" title="-">-</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
            </div>
          </div>
            ...
            <div class="col-sm-9">
              <div>
                <span id="worksheet-upload-btn-container" style="position: relative;">
                  <button type="button" id="worksheet-upload-btn" class="btn btn-pure icon iconfont icon-attachment" style="z-index: 1;"> 添加附件 </button>
                <div id="html5_1cn32ls4n16531een1k7o1mrfob24_container" class="moxie-shim moxie-shim-html5" style="position: absolute; top: 0px; left: 0px; width: 0px; height: 0px; overflow: hidden; z-index: 0;"><input id="html5_1cn32ls4n16531een1k7o1mrfob24" type="file" style="font-size: 999px; opacity: 0; position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;" multiple="" accept="" tabindex="-1"></div></span>
              </div>
              <div id="worksheet-files" class="upload-attachments">
                <div class="upload-attachment-item hide" id="upload-worksheet-attachment-item-clone">
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" id="add-worksheet-btn" type="button">确定</button>
      ...
      <div class="modal-body padding-horizontal-20">
        <form id="form-transfer-worksheet">
          <div class="form-group">
            ...
            <select class="form-control select2-hidden-accessible" name="worksheet-newProcessUserId" id="worksheet-newProcessUserId" data-plugin="select2" data-language="zh-CN" data-width="100%" tabindex="-1" aria-hidden="true">
              <option value="QVtaSg==">孙伟</option>
            </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-worksheet-newProcessUserId-container"><span class="select2-selection__rendered" id="select2-worksheet-newProcessUserId-container" title="孙伟">孙伟</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
          </div>
        </form>
      </div>
      <div class="modal-footer">
      ...
      <div class="modal-body padding-horizontal-20">
        <form id="form-change-customer">
          <div class="form-group">
            ...
            <select class="form-control select2-hidden-accessible" name="entity-change-customerId" id="entity-change-customerId" data-language="zh-CN" data-width="100%" data-field-required="false" tabindex="-1" aria-hidden="true">
...
<script type="text/javascript" src="script/worksheet.js"></script>
<script type="text/javascript" src="script/worksheet-list.js"></script>
